          ...
          <VStack space={4}>
            ...
            <VStack space={5}>
              <Text className="text-gray-500">
                ...
                servicios de Expense Tracker y a la información relacionada con
                los mismos, así como la realización de operaciones relacionadas
                con la aplicación. El uso de esta aplicación se rige por los
